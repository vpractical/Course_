...
public class 数独 {
    ...
    public static void sudoku2(int i, int j) {
        if (i == 8 && j == 9) {
            printResult();
            return;
        }
    ...
    public static boolean judge2(int i, int j, int number) {
        ...
        for (int k = 0; k < 9; k++) {
            if (result[i][k] == number || result[k][j] == number) {
                return false;
            }
        }
        ...
        for (int ki = di * 3; ki < di * 3 + 3; ki++) {
            for (int kj = dj * 3; kj < dj * 3 + 3; kj++) {
                if (result[ki][kj] == number) {
                    return false;
                }
            }
        }
